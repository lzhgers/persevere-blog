      ...
      <div class="login-wrapper">
        ...
        <div class="login-form">
          ...
          <div class="password form-item">
            <span>密码</span>
            <input type="password" class="input-item" v-model="userForm.password" @keyup.enter="onSubmit">
          </div>
          <button class="login-btn" @click="onSubmit">登 录</button>
        </div>
        <div style="margin-top: 10px"></div>
        <router-link class="regist" style="margin-left: 10px;margin-top: 10px" to="/regist">
          立即注册
        </router-link>
        <router-link class="wjmm" style="float:right;" to="/forgetPassword">
          忘记密码
        </router-link>
        <div class="divider">
...
.wjmm:hover, .regist:hover, .home:hover {
  color: #34536c;
  cursor: pointer;
